...
export const vertex2: Vertex = { id: "v2", lat: 37.450167, lng: 126.654056, isMain: false };
export const vertex3: Vertex = { id: "v3", lat: 37.451167, lng: 126.655056, isMain: false };
export const vertex4: Vertex = { id: "v4", lat: 37.452167, lng: 126.656056, isMain: true };
